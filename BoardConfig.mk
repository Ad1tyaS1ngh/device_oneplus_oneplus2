...
BOARD_KERNEL_CMDLINE += androidboot.android_dt_dir=/non-existent androidboot.boot_devices=soc.0/f9824900.sdhci
...
BOARD_SUPER_PARTITION_GROUPS := oneplus_dynpart
BOARD_ONEPLUS_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_ONEPLUS_DYNPART_PARTITION_LIST := system vendor
